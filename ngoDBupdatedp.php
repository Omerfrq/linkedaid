			...
			<div class="col col-xl-9 order-xl-2 col-lg-9 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
				<div class="ui-block">
					<div class="ui-block-title">
						<h6 class="title"><?php echo $user_data['ngo_name']; ?> - Update Display Picture</h6>
					</div>
							...
							<div class="row">
								...
								<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<div class="form-group ">
										...
										<input class="form-control" placeholder="" id="ngo_profile_pic" name="ngo_profile_pic" type="file">
									</div>
								</div>

								<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
									<button type="submit" class="btn btn-breez btn-lg full-width" id="updatePic">Update</button>
								</div>
